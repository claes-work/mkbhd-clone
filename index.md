...
- [wiki/sources/youtube-index.md](wiki/sources/youtube-index.md) — YouTube sub-index (grown by the ingest loop). **217 videos ingested (L2)** — @mkbhd P1/origin + @Waveform + @AutoFocus P2 (EV reviews, incl. 2026 Q1 batch) + @mkbhd 2009 origin P2 (tutorials/first unboxing/first review, incl. Fraps/Firefox/Thunderbird/Justhearit freeware how-tos + wallpapers/IE/Firefox/Safari-WebKit browser cluster, DreamScene, webcam-mic-boost, screencast-zoom, Vista tweaks: UAC/virtual-memory/menu-delay/boot-speed/ViStart/volume-mixer + Acid3 WebKit benchmark + Camtasia/CamStudio production-tooling cluster incl. first HD test + command-prompt/sidebar/RocketDock customization + macOS-in-Windows cluster: RocketDock/Firefox OS X themes + OS X cursors, offline Gmail, Vista Explorer/Start-menu tweaks, Firefox Superbar, speedtest + Aero Shake/SRWare Iron first-look/Vista screenshots/CamStudio zoom/Safari speed/classic Start menu/compatibility mode/Sage dictionary + CamStudio review/iTunes 8 Plus/YouTube-layouts branding/battery-saver-#1 webcam/Safari autofill/internet-speed benchmark/Google Earth 5.0 + Windows-7 first-look/$50-upgrade opinion, WMP-11-in-XP, Vista AutoPlay, battery-saver #2-#3 (disable-Aero/external-devices), Animoto YouTube-intro production pipeline, eliminate-background-tasks + battery-saver-#4 power-options/iTunes-visualizer/upgrade-Safari/CamStudio-autopan+A-V-sync/HD-encode-for-YouTube-720p/Skype-review + "New Ideas" tech-talk-format announcement) batches (2026-07-20).
